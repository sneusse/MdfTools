...
namespace MdfToolsMatlab
{
    ...
    public class MdfBufferAdapter : IDisposable
    {
        ...
        public string GetDisplayValueForDouble(double value) =>
            Channel.Org.GetDisplayValue(value);
    ...
    public class ChannelList
    {
        ...
        public MdfBufferAdapter[] Load(long sampleLimit = -1)
        {
            if (_adapters != null)
                return _adapters;
            ...
            var smp = Mdf4Sampler.CreateMany(toLoad, sampleLimit).SelectMany(k => k.Buffers).ToArray();
